      ...
      <section className="w-full py-12 md:py-24 lg:py-32" id="example">
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            <Link href="https://hsuwai.com/public/clwolrm540000p5opdi9l64k8">
            ...
            <Link href="https://hsuwai.com/public/clwoo1x210000utsg0nu0ajhv">
              <Card className="rounded-lg overflow-hidden bg-card shadow-lg py-2">
                <Image
            ...
            <Link href="https://hsuwai.com/public/clwoolvja00009fmnh259hzp6">
              <Card className="rounded-lg overflow-hidden bg-card shadow-lg  py-2">
                <Image
